...
@section('header', 'Tambah Pemeriksaan Baru')

@section('content')
<div class="max-w-4xl mx-auto">
    <form method="POST" action="{{ route('petugas_lab.pemeriksaan.store') }}">
        @csrf
        ...
        <div class="stat-card" style="margin-bottom: 1.5rem;">
            ...
            <div style="margin-bottom: 1rem;">
                <label style="display: block; font-size: 0.8rem; font-weight: 600; color: #374151; margin-bottom: 0.5rem;">
                    Pilih Pasien <span style="color: #ef4444;">*</span>
                </label>
        ...
        <div class="stat-card" style="margin-bottom: 1.5rem;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1rem;">
                <div>
                    ...
                    <input type="number" step="0.1" name="tinggi_cm" value="{{ old('tinggi_cm') }}"
                ...
                <div>
                    ...
                    <input type="number" step="0.1" name="berat_kg" value="{{ old('berat_kg') }}"
                           style="width: 100%; padding: 0.75rem; border: 1.5px solid #e5e7eb; border-radius: 10px; font-size: 0.85rem; outline: none;">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.1" name="lingkar_perut_cm" value="{{ old('lingkar_perut_cm') }}"
                           style="width: 100%; padding: 0.75rem; border: 1.5px solid #e5e7eb; border-radius: 10px; font-size: 0.85rem; outline: none;">
                </div>
            </div>
        </div>
        ...
        <div class="stat-card" style="margin-bottom: 1.5rem;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                <div>
                    ...
                    <input type="number" name="sistolik" value="{{ old('sistolik') }}"
                           style="width: 100%; padding: 0.75rem; border: 1.5px solid #e5e7eb; border-radius: 10px; font-size: 0.85rem; outline: none;">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="diastolik" value="{{ old('diastolik') }}"
                           style="width: 100%; padding: 0.75rem; border: 1.5px solid #e5e7eb; border-radius: 10px; font-size: 0.85rem; outline: none;">
                </div>
            </div>
        </div>
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 0.75rem;">
                    ...
                    <div>
                        ...
                        <input type="text" name="hasil[{{ $param->id }}]" value="{{ old('hasil.' . $param->id) }}"
